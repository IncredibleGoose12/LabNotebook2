# [06/01/2026]
## Daily To Do List
-  Okay, today is the day we are doing our first test run of samples!! 
	-  [x] Extract three specimens! (528 (normal) ,534 (disease margin), 535 (disease tissue))
	-  [x] Create aliquots for future extractions
	-  [x] Review reading club paper!
...
## Daily To Do List
-  [x] Meet with Nikea
-  [x] Create metadata sheet for extractions
-  [x] Reach out to contact from Metheun Upper and Lower School
-  [ ] Nanodrop the samples from yesterday to verify concentration
-  [x] Ask Caroline if she enriched her 16s samples, or if she did PCR with raw extract
