...
- Countless presentations and projects, but there is little left to do going forward, so that's nice. Crazy to think writing a 20 page paper is seen as the easy part, but so it is.
### Notes

## What I plan to do this week

- I'm currently reading Carolines thesis to steal her structure, then will go through my papers and grab some of the background information aspects. I bet I can use a bunch of pictures as well to fill space. Is that evil to do?

## Nikea notes
_Great job this week! let's map out the results and discussion section in our meeting today_
...
# 08/12/2026
## What I accomplished last week
- A ton of extractions, looking close to the end of the first round, though I know there was talk of adding more? _yes we talked last week about you also extracting the probiotic trial samples from Plazadetoros which is the only site left with the field trial samples to extract. we can chat more about that today_
- Got the PhD stuff/TA stuff sorted out _phew_
- Did my first PCR on my own! (Sarah watched/was around for questions) _woot! thats awesome!_
- Actually read that paper I was supposed to! _if our meeting ends early with Sarah we can talk about it, if not next week_
### Notes
- I really liked the suggestion that Sarah made of testing out a temp gradient on coral samples, will have to put some thought into that
- Have to make sure that I am on top of Masters requirements as they come up
- Call union, figure out health insurance plan
## What I plan to do this week
- Continue to do extractions, I would really like to have all of these done by the time school starts. _how many sets left?_
- I have to create a schedule/timeline for these TA responsibilities, as well as the graduate requirements (I know there are a few orientations, but I will double check with Tani (who is also attending them) that I have everything I need to do! _good idea! have you been assigned a class yet?_


_______
# 08/19/2026
## What I accomplished last week
- Last week was crazy busy and I am very happy with how everything went. I did three extractions, learned how to do PCR, and woke up at 4am to drive an hour for field work (I thought I was gonna fumble this one for sure!!)! Very very happy with how things have gone recently.
- Got the meetings and orientations sorted
	- 8/24 - Grad student orientation
	- 8/25 - Mandatory TA training
	- 9/4 - Mandatory TA training
- Put some thought into coral pcr design -
	- I was thinking I could maybe select two samples, one with a bit higher concentration (30~ng/ul), as well as one with a lower concentration (<5ng/ul), and do a 1:10 dilution of each, and run a temperature gradient to see if we can't find the best annealing temp.
### Notes
